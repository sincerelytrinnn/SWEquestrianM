...
public class LeadAnchorItem extends ItemBase {
    ...
    public static ActionResultType bindPlayerMobs(
            PlayerEntity pPlayer, World pLevel, BlockPos pPos, BlockState state) {
    ...
    public ActionResultType useOn(ItemUseContext pContext) {
        ...
        if (world.isEmptyBlock(anchorPos)
                && world.getBlockState(blockpos).isFaceSturdy(world, blockpos, pContext.getClickedFace())) {
