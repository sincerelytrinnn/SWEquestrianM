...
public class ArmorBaseItem extends ArmorItem {
  ...
  public ArmorBaseItem(
      ...
      Supplier<Supplier<ArmorBaseModel>> armorModel) {
  ...
  @Nullable
  @Override
  public final BipedModel getArmorModel(
      LivingEntity entity, ItemStack stack, EquipmentSlotType armorSlot, BipedModel defaultArmor) {
