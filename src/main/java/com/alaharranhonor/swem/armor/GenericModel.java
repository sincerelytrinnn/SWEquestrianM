...
public class GenericModel extends ArmorBaseModel {
  ...
  public void setupArmorParts() {
    ...
    myArmorHead
        .setTexSize(0, 16)
        .addBox(-4.0556F, 3.5556F, -6.6111F, 8.0F, 1.0F, 8.0F, 0.0F, false);
    myArmorHead
        .setTexSize(51, 52)
        .addBox(-4.0556F, 4.5556F, 1.3889F, 8.0F, 8.0F, 1.0F, 0.0F, false);
    myArmorHead
        .setTexSize(18, 41)
        .addBox(-5.0556F, 4.5556F, -6.6111F, 1.0F, 5.0F, 8.0F, 0.0F, false);
    myArmorHead
        .setTexSize(23, 62)
        .addBox(-6.0556F, 4.5556F, -5.6111F, 1.0F, 3.0F, 3.0F, 0.0F, false);
    myArmorHead
        .setTexSize(18, 59)
        .addBox(4.9444F, 4.5556F, -5.6111F, 1.0F, 3.0F, 3.0F, 0.0F, false);
    myArmorHead
        .setTexSize(36, 24)
        .addBox(4.9444F, 5.5556F, -2.6111F, 1.0F, 2.0F, 1.0F, 0.0F, false);
    myArmorHead
        .setTexSize(0, 25)
        .addBox(-6.0556F, 5.5556F, -2.6111F, 1.0F, 2.0F, 1.0F, 0.0F, false);
    myArmorHead
        .setTexSize(66, 66)
        .addBox(-5.0556F, 9.5556F, -6.6111F, 1.0F, 1.0F, 3.0F, 0.0F, false);
    myArmorHead
        .setTexSize(15, 65)
        .addBox(3.9444F, 9.5556F, -6.6111F, 1.0F, 1.0F, 3.0F, 0.0F, false);
    myArmorHead
        .setTexSize(61, 62)
        .addBox(-5.0556F, 9.5556F, -1.6111F, 1.0F, 3.0F, 3.0F, 0.0F, false);
    myArmorHead
        .setTexSize(42, 62)
        .addBox(3.9444F, 9.5556F, -1.6111F, 1.0F, 3.0F, 3.0F, 0.0F, false);
    myArmorHead.setTexSize(0, 41).addBox(3.9444F, 4.5556F, -6.6111F, 1.0F, 5.0F, 8.0F, 0.0F, false);
    myArmorHead
        .setTexSize(33, 72)
        .addBox(-0.5556F, 7.5556F, -8.6111F, 1.0F, 5.0F, 1.0F, 0.0F, false);
    myArmorHead
        .setTexSize(29, 72)
        .addBox(-0.5556F, 1.5556F, -8.6111F, 1.0F, 5.0F, 1.0F, 0.0F, false);
