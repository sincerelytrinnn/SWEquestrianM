...
public class ClientEventHandlers {
    ...
    public static void onParticleFactoryRegister(ParticleFactoryRegisterEvent event) {
        Minecraft.getInstance()
                .particleEngine
                .register(SWEMParticles.BAD.get(), BadParticle.Factory::new);
        Minecraft.getInstance()
                .particleEngine
                .register(SWEMParticles.ECH.get(), EchParticle.Factory::new);
        Minecraft.getInstance()
                .particleEngine
                .register(SWEMParticles.MEH.get(), MehParticle.Factory::new);
        Minecraft.getInstance()
                .particleEngine
                .register(SWEMParticles.YAY.get(), YayParticle.Factory::new);
        Minecraft.getInstance()
                .particleEngine
                .register(SWEMParticles.WOOT.get(), WootParticle.Factory::new);
    }
    ...
    public static void initLate() {
        ScreenManager.register(
                SWEMContainers.SWEM_HORSE_CONTAINER.get(), SWEMHorseInventoryScreen::new);
        ScreenManager.register(SWEMContainers.TACKBOX_CONTAINER.get(), TackBoxDefaultScreen::new);
        ScreenManager.register(
                SWEMContainers.CANTAZARITE_ANVIL_CONTAINER.get(), CantazariteAnvilScreen::new);
        ScreenManager.register(
                SWEMContainers.SADDLE_BAG_AND_BEDROLL_CONTAINER.get(), SaddlebagAndBedrollScreen::new);
        ...
        ItemModelsProperties.register(
                SWEMItems.AMETHYST_BOW.get(),
                new ResourceLocation("pull"),
                (p_239429_0_, p_239429_1_, p_239429_2_) -> {
                    if (p_239429_2_ == null) {
                        return 0.0F;
                    } else {
                        return p_239429_2_.getUseItem() != p_239429_0_
                                ? 0.0F
        ...
        ItemModelsProperties.register(
                ...
                (p_239428_0_, p_239428_1_, p_239428_2_) ->
                        p_239428_2_ != null
                                && p_239428_2_.isUsingItem()
                                && p_239428_2_.getUseItem() == p_239428_0_
                                ? 1.0F
                                : 0.0F);
        ItemModelsProperties.register(
                SWEMItems.AMETHYST_SHIELD.get(),
                new ResourceLocation("blocking"),
                (p_239421_0_, p_239421_1_, p_239421_2_) -> {
                    return p_239421_2_ != null
                            && p_239421_2_.isUsingItem()
                            && p_239421_2_.getUseItem() == p_239421_0_
                            ? 1.0F
                            : 0.0F;
                });
    }
    ...
    public static void registerRenderers(final FMLClientSetupEvent event) {
        RenderingRegistry.registerEntityRenderingHandler(
                SWEMEntities.SWEM_HORSE_ENTITY.get(), SWEMHorseRender::new);
        RenderingRegistry.registerEntityRenderingHandler(
                SWEMEntities.WORMIE_BOI_ENTITY.get(), WormieBoiRender::new);
        RenderingRegistry.registerEntityRenderingHandler(
                SWEMEntities.HORSE_POOP_ENTITY.get(), PoopRender::new);
        ClientRegistry.bindTileEntityRenderer(
                SWEMTileEntities.ONE_SADDLE_RACK_TILE_ENTITY.get(), OneSaddleRackRender::new);
        ClientRegistry.bindTileEntityRenderer(
                SWEMTileEntities.BRIDLE_RACK_TILE_ENTITY.get(), BridleRackRender::new);
        ClientRegistry.bindTileEntityRenderer(
                SWEMTileEntities.HORSE_ARMOR_RACK_TILE_ENTITY.get(), HorseArmorRackRender::new);
        ClientRegistry.bindTileEntityRenderer(
                SWEMTileEntities.SWEM_SIGN.get(), SignTileEntityRenderer::new);
        GeoArmorRenderer.registerArmorRenderer(
                LeatherRidingBoots.class, new AmethystArmorModelRenderer());
        ...
        GeoArmorRenderer.registerArmorRenderer(
                DiamondRidingBoots.class, new AmethystArmorModelRenderer());
        GeoArmorRenderer.registerArmorRenderer(
                AmethystRidingBoots.class, new AmethystArmorModelRenderer());
        GeoArmorRenderer.registerArmorRenderer(AmethystHelmet.class, new AmethystArmorModelRenderer());
        GeoArmorRenderer.registerArmorRenderer(
                AmethystChestplate.class, new AmethystArmorModelRenderer());
        GeoArmorRenderer.registerArmorRenderer(
                AmethystLeggings.class, new AmethystArmorModelRenderer());
    }
    ...
    public static void setRenderLayers() {
        ...
        RenderTypeLookup.setRenderLayer(
                SWEMBlocks.JUMP_STANDARD_SCHOOLING.get(), RenderType.translucent());
        ...
        for (DyeColor color : DyeColor.values()) {
            RenderTypeLookup.setRenderLayer(
                    SWEMBlocks.ROLL_TOPS.get(color.getId()).get(), RenderType.translucent());
            RenderTypeLookup.setRenderLayer(
                    SWEMBlocks.RAILS.get(color.getId()).get(), RenderType.translucent());
            RenderTypeLookup.setRenderLayer(
                    SWEMBlocks.GROUND_POLES.get(color.getId()).get(), RenderType.translucent());
            RenderTypeLookup.setRenderLayer(
                    SWEMBlocks.POLE_ON_BOXES_SMALL.get(color.getId()).get(), RenderType.translucent());
            RenderTypeLookup.setRenderLayer(
                    SWEMBlocks.POLE_ON_BOXES_LARGE.get(color.getId()).get(), RenderType.translucent());
            RenderTypeLookup.setRenderLayer(
                    SWEMBlocks.FANCY_PLANKS.get(color.getId()).get(), RenderType.translucent());
            RenderTypeLookup.setRenderLayer(
                    SWEMBlocks.PLANKS.get(color.getId()).get(), RenderType.translucent());
            RenderTypeLookup.setRenderLayer(
                    SWEMBlocks.PANELS_WAVE.get(color.getId()).get(), RenderType.translucent());
            RenderTypeLookup.setRenderLayer(
                    SWEMBlocks.PANELS_STRIPE.get(color.getId()).get(), RenderType.translucent());
            RenderTypeLookup.setRenderLayer(
                    SWEMBlocks.PANELS_ARROW.get(color.getId()).get(), RenderType.translucent());
            RenderTypeLookup.setRenderLayer(
                    SWEMBlocks.FLOWER_BOXES.get(color.getId()).get(), RenderType.translucent());
            RenderTypeLookup.setRenderLayer(
                    SWEMBlocks.CAVALETTIS.get(color.getId()).get(), RenderType.translucent());
            RenderTypeLookup.setRenderLayer(
                    SWEMBlocks.WHEEL_BARROWS.get(color.getId()).get(), RenderType.cutout());
            RenderTypeLookup.setRenderLayer(
                    SWEMBlocks.SEPARATORS.get(color.getId()).get(), RenderType.cutout());
            RenderTypeLookup.setRenderLayer(
                    SWEMBlocks.PASTURE_GATES_HORSE.get(color.getId()).get(), RenderType.cutout());
            RenderTypeLookup.setRenderLayer(
                    SWEMBlocks.PASTURE_GATES_CARE.get(color.getId()).get(), RenderType.cutout());
            RenderTypeLookup.setRenderLayer(
                    SWEMBlocks.WEB_GUARDS_CARE.get(color.getId()).get(), RenderType.cutout());
            RenderTypeLookup.setRenderLayer(
                    SWEMBlocks.WEB_GUARDS_HORSE.get(color.getId()).get(), RenderType.cutout());
            RenderTypeLookup.setRenderLayer(
                    SWEMBlocks.WEB_GUARDS_RIDER.get(color.getId()).get(), RenderType.cutout());
        }
    }
    ...
    public static void registerKeybinds() {
        ...
        keyBindings[0] =
                new KeyBinding("key.swem.horse.increment", GLFW.GLFW_KEY_H, "key.swem.category");
        keyBindings[1] =
                new KeyBinding("key.swem.horse.decrement", GLFW.GLFW_KEY_G, "key.swem.category");
        keyBindings[2] =
                new KeyBinding(
                        "key.swem.horse.toggle_saddlebag_and_bedroll", GLFW.GLFW_KEY_K, "key.swem.category");
        keyBindings[3] =
                new KeyBinding("key.swem.horse.toggle_flight", GLFW.GLFW_KEY_J, "key.swem.category");
        keyBindings[4] =
                new KeyBinding("key.swem.horse.toggle_wings", GLFW.GLFW_KEY_PERIOD, "key.swem.category");
        keyBindings[5] =
                new KeyBinding("key.swem.horse.dive_flight", GLFW.GLFW_KEY_X, "key.swem.category");
        keyBindings[7] =
                new KeyBinding("key.swem.horse.camera_lock", GLFW.GLFW_KEY_LEFT_ALT, "key.swem.category");
        keyBindings[8] =
                new KeyBinding("key.swem.performance_gain", GLFW.GLFW_KEY_U, "key.swem.category");

        // TODO: REMOVE ONCE SPEED HAS BEEN CONFIRMED
        keyBindings[6] =
                new KeyBinding("key.swem.horse.check_speed", GLFW.GLFW_KEY_N, "key.swem.category");
    ...
    public static void onRegisterBlockColors(ColorHandlerEvent.Block event) {
            ...
            colors.register(
                    (state, reader, pos, color) -> {
                        return reader != null && pos != null
                                ? BiomeRegistry.PLAINS.getWaterColor()
                                : -1; // Figure out how to get the PLAINS biome only.
                    },
                    barrel);
        }
        ...
        colors.register(
                (state, reader, pos, color) ->
                        reader != null && pos != null ? BiomeColors.getAverageWaterColor(reader, pos) : -1,
                waterTrough);
    ...
    public static void onRegisterItemColors(ColorHandlerEvent.Item event) {
        event
                .getItemColors()
                .register(
                        (p_210239_0_, p_210239_1_) -> {
                            return p_210239_1_ > 0
                                    ? -1
                                    : ((IDyeableArmorItem) p_210239_0_.getItem()).getColor(p_210239_0_);
                        },
                        SWEMItems.WESTERN_LEG_WRAPS.get(),
                        SWEMItems.ENGLISH_LEG_WRAPS.get());
    }
    ...
    public static void onRegisterItems(RegistryEvent.Register<Item> event) {
        event
                .getRegistry()
                .register(
                        new SWEMSpawnEggItem(
                                SWEMEntities.WORMIE_BOI_ENTITY,
                                Color.parseColor("#bf7b05").getValue(),
                                Color.parseColor("#663c02").getValue(),
                                new Item.Properties().tab(SWEM.TAB))
                                .setRegistryName("worm_spawn_egg"));
        event
                .getRegistry()
                .register(
                        new SWEMSpawnEggItem(
                                ...
                                Color.parseColor("#663c02").getValue(),
                                new Item.Properties().tab(SWEM.TAB))
                                .setRegistryName("swem_horse_spawn_egg"));
    }
    ...
    static class ForgeBusHandlers {
        ...
        public static final ResourceLocation GUI_ICONS_LOCATION =
                new ResourceLocation(SWEM.MOD_ID, "textures/gui/icons.png");
        ...
        public static void onRenderHorseJumpBar(RenderGameOverlayEvent.Pre event) {
            ...
            if (j > 0) {
                Minecraft.getInstance()
                        .gui
                        .blit(stack, xPosition + 1, k, 201 - ((level + 1) * 40), 25, amountToDraw, 5, 201, 30);
            }
        }
        ...
        public static void onUIRender(RenderGameOverlayEvent.Post event) {
            ...
            if (Minecraft.getInstance().player.getVehicle() instanceof SWEMHorseEntityBase) {
                String gait =
                        SWEMHorseEntityBase.HorseSpeed.values()[
                                Minecraft.getInstance()
                                        .player
                                        .getVehicle()
                                        .getEntityData()
                                        .get(SWEMHorseEntityBase.SPEED_LEVEL)]
                                .getText();
                float xPos = event.getWindow().getGuiScaledWidth() / 2.0f + (4.5f * 20) + 4;
                float yPos = event.getWindow().getGuiScaledHeight() - 14;
                Minecraft.getInstance()
                        .font
                        .draw(event.getMatrixStack(), gait, xPos, yPos, TextFormatting.WHITE.getColor());
            }
        }
            ...
            if (shouldAnimate) {
                PlayerCapability.IPlayerCapability playerCapability =
                        CapabilityHandler.getCapability(
                                player, PlayerCapability.PlayerProvider.PLAYER_CAPABILITY);
                if (playerCapability != null) {
                    GeckoRider.GeckoRiderFirstPerson geckoPlayer =
                            RiderFirstPersonRenderer.GECKO_PLAYER_FIRST_PERSON;
                    if (geckoPlayer != null) {
                        ModelGeckoRiderFirstPerson geckoFirstPersonModel =
                                (ModelGeckoRiderFirstPerson) geckoPlayer.getModel();
                        RiderFirstPersonRenderer firstPersonRenderer =
                                (RiderFirstPersonRenderer) geckoPlayer.getPlayerRenderer();
                        ...
                        if (geckoFirstPersonModel != null && firstPersonRenderer != null) {
                            ...
                            //                        }
                            event.setCanceled(
                                    geckoFirstPersonModel.resourceForModelId((AbstractClientPlayerEntity) player));
        ...
        public static void renderLivingEvent(RenderPlayerEvent.Pre event) {
            if (event.getEntity() instanceof PlayerEntity) {
                ...
                PlayerCapability.IPlayerCapability playerCapability =
                        CapabilityHandler.getCapability(
                                event.getEntity(), PlayerCapability.PlayerProvider.PLAYER_CAPABILITY);
                if (playerCapability != null) {
                    GeckoRider.GeckoRiderThirdPerson geckoPlayer = playerCapability.getGeckoPlayer();
                    if (geckoPlayer != null) {
                        ModelGeckoRiderThirdPerson geckoPlayerModel =
                                (ModelGeckoRiderThirdPerson) geckoPlayer.getModel();
                        RiderRenderPlayer animatedPlayerRenderer =
                                (RiderRenderPlayer) geckoPlayer.getPlayerRenderer();

                        if (geckoPlayerModel != null
                                && animatedPlayerRenderer != null
                                && player.getVehicle() instanceof SWEMHorseEntityBase) {
                            if (!geckoPlayerModel.isUsingSmallArms()
                                    && ((AbstractClientPlayerEntity) player).getModelName().equals("slim")) {
                            ...
                            if (event.isCanceled()) {
                                animatedPlayerRenderer.render(
                                        (AbstractClientPlayerEntity) event.getEntity(),
                                        event.getEntity().yRot,
                                        delta,
                                        event.getMatrixStack(),
                                        event.getBuffers(),
                                        event.getLight(),
