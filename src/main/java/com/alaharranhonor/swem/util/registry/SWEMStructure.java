...
public class SWEMStructure {
    ...
    /**
     * This is where we set the rarity of your structures and determine if land conforms to it. See
     * the comments in below for more details.
     */
    ...
    /**
     * Adds the provided structure to the registry, and adds the separation settings. The rarity of
     * the structure is determined based on the values passed into this method in the
     * structureSeparationSettings argument. This method is called by setupStructures above.
     */
    public static <F extends Structure<?>> void setupMapSpacingAndLand(
            F structure,
            StructureSeparationSettings separationSettings,
            boolean transformSorroundingLand) {
        /*
