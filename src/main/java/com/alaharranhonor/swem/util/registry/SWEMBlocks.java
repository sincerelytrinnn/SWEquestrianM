...
public class SWEMBlocks {
	...
	public static final RegistryObject<WaterThroughBlock> WATER_TROUGH = BLOCKS.register("water_trough", () -> new WaterThroughBlock(AbstractBlock.Properties.of(Material.METAL), DyeColor.BLACK));
