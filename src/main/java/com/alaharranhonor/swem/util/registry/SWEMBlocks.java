...
public class SWEMBlocks {
    ...
    static {
        ...
        for (DyeColor color : DyeColor.values()) {
            ...
            WHEEL_BARROWS.add(register("wheel_barrow_" + color.toString(), () -> new WheelBarrowBlock(AbstractBlock.Properties.of(Material.METAL).noOcclusion().sound(SoundType.METAL).harvestTool(ToolType.PICKAXE).strength(2.5F, 3.5F), color), block -> () -> new BlockItemBase(block.get())));
            SLOW_FEEDERS.add(register("slow_feeder_" + color.toString(), () -> new SlowFeederBlock(AbstractBlock.Properties.of(Material.METAL).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE).strength(3.0F, 4.0F), color), block -> () -> new BlockItemBase(block.get())));
            SEPARATORS.add(register("separator_" + color.toString(), () -> new SeparatorBlock(AbstractBlock.Properties.of(Material.METAL).sound(SoundType.METAL).harvestTool(ToolType.PICKAXE).strength(2.5F, 3.5F), color), block -> () -> new BlockItemBase(block.get())));
            GRAIN_FEEDERS.add(register("grain_feeder_" + color.toString(), () -> new GrainFeederBlock(AbstractBlock.Properties.of(Material.METAL).noOcclusion().sound(SoundType.METAL).harvestTool(ToolType.PICKAXE).strength(2.0F, 3.0F), color), block -> () -> new BlockItemBase(block.get())));
            PASTURE_GATES_HORSE.add(register("pasture_" + color.toString() + "_horse", () -> new HorseDoorBlock(AbstractBlock.Properties.of(Material.METAL).noOcclusion().strength(1.0f), color), block -> () -> new BlockItemBase(block.get())));
            PASTURE_GATES_CARE.add(register("pasture_" + color.toString() + "_care", () -> new CareDoorBlock(AbstractBlock.Properties.of(Material.METAL).noOcclusion().strength(1.0f), color), block -> () -> new BlockItemBase(block.get())));
            WEB_GUARDS_CARE.add(register("web_guard_" + color.toString() + "_care", () -> new CareDoorHalfBlock(AbstractBlock.Properties.of(Material.METAL).noOcclusion().strength(1.0f), color), block -> () -> new BlockItemBase(block.get())));
            WEB_GUARDS_HORSE.add(register("web_guard_" + color.toString() + "_horse", () -> new HorseDoorHalfBlock(AbstractBlock.Properties.of(Material.METAL).noOcclusion().strength(1.0f), color), block -> () -> new BlockItemBase(block.get())));
            WEB_GUARDS_RIDER.add(register("web_guard_" + color.toString() + "_rider", () -> new HalfDoorBlock(AbstractBlock.Properties.of(Material.METAL).noOcclusion().strength(1.0f)), block -> () -> new BlockItemBase(block.get())));
            HALF_BARRELS.add(register("half_barrel_" + color.getName(), () -> new HalfBarrelBlock(Block.Properties.of(Material.METAL).noOcclusion().sound(SoundType.METAL).harvestTool(ToolType.PICKAXE).strength(2.0F, 3.0F)), block -> () -> new BlockItemBase(block.get())));
            TACK_BOX.add(register("tack_box_" + color.toString(), () -> new TackBoxBlock(Block.Properties.of(Material.WOOD).noOcclusion().sound(SoundType.WOOD).harvestTool(ToolType.AXE).strength(2.0F, 3.0F), color.getId()), block -> () -> new TackBoxBlockItem(block.get())));
        }
    }
