...
public class SWEMItems {
    ...
    public static final RegistryObject<PotionItem> RAINBOW_CHIC = ITEMS.register("rainbow_chic", () -> new RainbowChicPotionItem(new Item.Properties().stacksTo(1).tab(SWEM.TAB)));
