...
import com.alaharranhonor.swem.items.potions.CantazaritePotion;
...
public class RegistryHandler {
    ...
    public static final RegistryObject<Item> CANTAZARITE_POTION = ITEMS.register("cantazarite_potion", () -> new CantazaritePotion(new Item.Properties().group(SWEM.TAB).maxStackSize(1)));
    ...
    // BLANKETS
    public static final RegistryObject<BlanketItem> ENGLISH_BLANKET_BLACK = ITEMS.register("english_blanket_black", () -> new BlanketItem("english_blanket_black", new Item.Properties().group(SWEM.TAB).maxStackSize(1)));
    public static final RegistryObject<BlanketItem> ENGLISH_BLANKET_BLUE = ITEMS.register("english_blanket_blue", () -> new BlanketItem("english_blanket_blue", new Item.Properties().group(SWEM.TAB).maxStackSize(1)));
    public static final RegistryObject<BlanketItem> ENGLISH_BLANKET_BROWN = ITEMS.register("english_blanket_brown", () -> new BlanketItem("english_blanket_brown", new Item.Properties().group(SWEM.TAB).maxStackSize(1)));
    public static final RegistryObject<BlanketItem> ENGLISH_BLANKET_CYAN = ITEMS.register("english_blanket_cyan", () -> new BlanketItem("english_blanket_cyan", new Item.Properties().group(SWEM.TAB).maxStackSize(1)));
    public static final RegistryObject<BlanketItem> ENGLISH_BLANKET_GREEN = ITEMS.register("english_blanket_green", () -> new BlanketItem("english_blanket_green", new Item.Properties().group(SWEM.TAB).maxStackSize(1)));
    public static final RegistryObject<BlanketItem> ENGLISH_BLANKET_GRAY = ITEMS.register("english_blanket_gray", () -> new BlanketItem("english_blanket_gray", new Item.Properties().group(SWEM.TAB).maxStackSize(1)));
    public static final RegistryObject<BlanketItem> ENGLISH_BLANKET_LIGHT_BLUE = ITEMS.register("english_blanket_light_blue", () -> new BlanketItem("english_blanket_light_blue", new Item.Properties().group(SWEM.TAB).maxStackSize(1)));
    public static final RegistryObject<BlanketItem> ENGLISH_BLANKET_LIGHT_GRAY = ITEMS.register("english_blanket_light_gray", () -> new BlanketItem("english_blanket_light_gray", new Item.Properties().group(SWEM.TAB).maxStackSize(1)));
    public static final RegistryObject<BlanketItem> ENGLISH_BLANKET_LIME = ITEMS.register("english_blanket_lime", () -> new BlanketItem("english_blanket_lime", new Item.Properties().group(SWEM.TAB).maxStackSize(1)));
    public static final RegistryObject<BlanketItem> ENGLISH_BLANKET_MAGENTA = ITEMS.register("english_blanket_magenta", () -> new BlanketItem("english_blanket_magenta", new Item.Properties().group(SWEM.TAB).maxStackSize(1)));
    public static final RegistryObject<BlanketItem> ENGLISH_BLANKET_ORANGE = ITEMS.register("english_blanket_orange", () -> new BlanketItem("english_blanket_orange", new Item.Properties().group(SWEM.TAB).maxStackSize(1)));
    public static final RegistryObject<BlanketItem> ENGLISH_BLANKET_PINK = ITEMS.register("english_blanket_pink", () -> new BlanketItem("english_blanket_pink", new Item.Properties().group(SWEM.TAB).maxStackSize(1)));
    public static final RegistryObject<BlanketItem> ENGLISH_BLANKET_PURPLE = ITEMS.register("english_blanket_purple", () -> new BlanketItem("english_blanket_purple", new Item.Properties().group(SWEM.TAB).maxStackSize(1)));
    public static final RegistryObject<BlanketItem> ENGLISH_BLANKET_RED = ITEMS.register("english_blanket_red", () -> new BlanketItem("english_blanket_red", new Item.Properties().group(SWEM.TAB).maxStackSize(1)));
    public static final RegistryObject<BlanketItem> ENGLISH_BLANKET_WHITE = ITEMS.register("english_blanket_white", () -> new BlanketItem("english_blanket_white", new Item.Properties().group(SWEM.TAB).maxStackSize(1)));
    public static final RegistryObject<BlanketItem> ENGLISH_BLANKET_YELLOW = ITEMS.register("english_blanket_yellow", () -> new BlanketItem("english_blanket_yellow", new Item.Properties().group(SWEM.TAB).maxStackSize(1)));
...
// Blocks
    ...
    public static final RegistryObject<Block> SLOW_FEEDER = BLOCKS.register("slow_feeder", () -> new SlowFeederBlock(Block.Properties.create(Material.IRON)));

    public static final RegistryObject<Block> WESTERN_BARREL = BLOCKS.register("western_barrel", () -> new BarrelBlock(Block.Properties.create(Material.IRON)));
    ...
    public static final RegistryObject<Item> HALF_BARREL_ITEM = ITEMS.register("half_barrel", () -> new BlockItemBase(HALF_BARREL.get()));
    public static final RegistryObject<Item> SLOW_FEEDER_ITEM = ITEMS.register("slow_feeder", () -> new BlockItemBase(SLOW_FEEDER.get()));
    public static final RegistryObject<Item> WESTERN_BARREL_ITEM = ITEMS.register("western_barrel", () -> new BlockItemBase(WESTERN_BARREL.get()));
