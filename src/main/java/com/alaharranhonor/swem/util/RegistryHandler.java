...
public class RegistryHandler {
    ...
    public static final RegistryObject<ArmorItem> GLOW_RIDING_BOOTS = ITEMS.register("glow_riding_boots", () -> new GlowRidingBoots(ModArmorMaterial.GLOW, EquipmentSlotType.FEET, new Item.Properties().group(SWEM.TAB).maxStackSize(1), () -> ArmorItemRegistration::getLeatherArmor));
    public static final RegistryObject<Item> IRON_SCYTHE = ITEMS.register("iron_scythe", ItemBase::new);
    public static final RegistryObject<ArmorItem> IRON_RIDING_BOOTS = ITEMS.register("iron_riding_boots", () -> new IronRidingBoots(ModArmorMaterial.IRON, EquipmentSlotType.FEET, new Item.Properties().group(SWEM.TAB).maxStackSize(1), () -> ArmorItemRegistration::getLeatherArmor));
    ...
    public static final RegistryObject<ArmorItem> GOLD_RIDING_BOOTS = ITEMS.register("gold_riding_boots", () -> new GoldRidingBoots(ModArmorMaterial.GOLD, EquipmentSlotType.FEET, new Item.Properties().group(SWEM.TAB).maxStackSize(1), () -> ArmorItemRegistration::getLeatherArmor));
    ...
    public static final RegistryObject<ArmorItem> DIAMOND_RIDING_BOOTS = ITEMS.register("diamond_riding_boots", () -> new DiamondRidingBoots(ModArmorMaterial.DIAMOND, EquipmentSlotType.FEET, new Item.Properties().group(SWEM.TAB).maxStackSize(1), () -> ArmorItemRegistration::getLeatherArmor));
...
// Blocks
    ...
    public static final RegistryObject<Block> WATER_TROUGH = BLOCKS.register("water_trough", () -> new WaterTroughBase(WaterTroughBase.WaterTroughType.SINGLE, Block.Properties.create(Material.IRON)));
    ...
    public static final RegistryObject<Item> WATER_TROUGH_ITEM = ITEMS.register("water_trough",
            () -> new BlockItemBase(WATER_TROUGH.get()));
