...
public class SWEMCommand {
        ...
        return Commands.literal("swem")
                            ...
                            if (vehicle instanceof SWEMHorseEntityBase) {
                                ...
                                switch (skill) {
                                    ...
                                    case JUMP: {
                                        ...
                                        } else ctx.getSource().sendFailure(new StringTextComponent("Incorrect level range."));
            ...
            .then(Commands.literal("wild")
                .executes(ctx -> {
                    ...
                    inv.setItem(0, new ItemStack(SWEMItems.WESTERN_BRIDLES.get(DyeColor.GRAY.getId()).get()));
                    inv.setItem(1, new ItemStack(SWEMItems.WESTERN_BLANKETS.get(DyeColor.GRAY.getId()).get()));
                    inv.setItem(2, new ItemStack(SWEMItems.WESTERN_SADDLES.get(DyeColor.GRAY.getId()).get()));
                    inv.setItem(5, new ItemStack(SWEMItems.WESTERN_GIRTH_STRAPS.get(DyeColor.GRAY.getId()).get()));
    ...
    public enum Skills {
        ALL, SPEED, JUMP, HEALTH, AFFINITY;
    }
}
