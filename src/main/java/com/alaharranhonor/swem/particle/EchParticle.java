...
public class EchParticle extends SpriteTexturedParticle {

  /**
   * Instantiates a new Ech particle.
   *
   ...
   * @param z the z
   */
  private EchParticle(ClientWorld world, double x, double y, double z) {
  ...
  public static class Factory implements IParticleFactory<BasicParticleType> {
    ...
    public Particle createParticle(
        ...
        double ySpeed,
        double zSpeed) {
      EchParticle badParticle = new EchParticle(worldIn, x, y, z);
