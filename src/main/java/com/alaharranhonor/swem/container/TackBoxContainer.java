...
public class TackBoxContainer extends Container {
   ...
   */
  public TackBoxContainer(
      final int id, final PlayerInventory playerInventory, final TackBoxTE tileEntity) {
    super(SWEMContainers.TACKBOX_CONTAINER.get(), id);
    this.tileEntity = tileEntity;
    this.canInteractWithCallable =
        IWorldPosCallable.create(playerInventory.player.level, tileEntity.getBlockPos());
    ...
    int genericX = 8;
    this.addSlot(
        new Slot(this.tileEntity, 0, genericX, slotStartY) {
          @Override
          public boolean mayPlace(ItemStack stack) {
            return stack.getItem() instanceof HalterItem
                && !(stack.getItem() instanceof BridleItem);
          }
    ...
    this.addSlot(
        new Slot(this.tileEntity, 1, genericX, slotStartY + 3 + 18) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    this.addSlot(
        new Slot(this.tileEntity, 2, genericX, slotStartY + 6 + 36) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    int adventureX = 35;
    this.addSlot(
        new Slot(this.tileEntity, 3, adventureX, slotStartY) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    this.addSlot(
        new Slot(this.tileEntity, 4, adventureX + 3 + 18, slotStartY) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    this.addSlot(
        new Slot(this.tileEntity, 5, adventureX, slotStartY + 3 + 18) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    this.addSlot(
        new Slot(this.tileEntity, 6, adventureX + 3 + 18, slotStartY + 3 + 18) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    this.addSlot(
        new Slot(this.tileEntity, 7, adventureX, slotStartY + 6 + 36) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    this.addSlot(
        new Slot(this.tileEntity, 8, adventureX + 3 + 18, slotStartY + 6 + 36) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    int englishX = 83;
    this.addSlot(
        new Slot(this.tileEntity, 9, englishX, slotStartY) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    this.addSlot(
        new Slot(this.tileEntity, 10, englishX + 3 + 18, slotStartY) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    this.addSlot(
        new Slot(this.tileEntity, 11, englishX, slotStartY + 3 + 18) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    this.addSlot(
        new Slot(this.tileEntity, 12, englishX + 3 + 18, slotStartY + 3 + 18) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    this.addSlot(
        new Slot(this.tileEntity, 13, englishX, slotStartY + 6 + 36) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    this.addSlot(
        new Slot(this.tileEntity, 14, englishX + 3 + 18, slotStartY + 6 + 36) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    int westernX = 131;
    this.addSlot(
        new Slot(this.tileEntity, 15, westernX, slotStartY) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    this.addSlot(
        new Slot(this.tileEntity, 16, westernX + 3 + 18, slotStartY) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    this.addSlot(
        new Slot(this.tileEntity, 17, westernX, slotStartY + 3 + 18) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    this.addSlot(
        new Slot(this.tileEntity, 18, westernX + 3 + 18, slotStartY + 3 + 18) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    this.addSlot(
        new Slot(this.tileEntity, 19, westernX, slotStartY + 6 + 36) {
          @Override
          public boolean mayPlace(ItemStack stack) {
    ...
    this.addSlot(
        new Slot(this.tileEntity, 20, westernX + 3 + 18, slotStartY + 6 + 36) {
          @Override
          public boolean mayPlace(ItemStack stack) {
