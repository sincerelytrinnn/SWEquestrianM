...
public class TackBoxGeneticsScreen extends Screen {
    private static final ResourceLocation TACKBOX_GENETICS_TEXTURE =
            new ResourceLocation(SWEM.MOD_ID, "textures/gui/container/tackbox_genetics.png");
     ...
     */
    protected TackBoxGeneticsScreen(
