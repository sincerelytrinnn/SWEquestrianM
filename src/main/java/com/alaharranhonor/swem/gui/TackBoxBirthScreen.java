...
public class TackBoxBirthScreen extends Screen {
	...
	public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
		...
		if (this.container.horse != null) {
			...
			// Owner name.
			this.font.draw(matrixStack, new StringTextComponent(SWEMUtil.checkTextOverflow(horse.getOwnerName(), 22)), textX + 0.2f, this.guiTop + 54, 4210752);
			...
			// Health TEXT
			this.font.draw(matrixStack, new TranslationTextComponent(String.format("%s: %.1f/%.0f", healthLeveling.getLevelName(), horse.getHealth(), horse.getMaxHealth())), textX, this.guiTop + 96, 4210752);
