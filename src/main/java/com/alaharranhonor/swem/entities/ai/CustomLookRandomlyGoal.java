...
public class CustomLookRandomlyGoal extends Goal {
	...
	public void tick() {
		--this.lookTime;
		this.mob.getLookControl().setLookAt(this.mob.getX() + this.relX, this.mob.getEyeY(), this.mob.getZ() + this.relZ, this.mob.getMaxHeadYRot(), (float)this.mob.getMaxHeadXRot());
	}
}
