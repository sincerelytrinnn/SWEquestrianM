...
public enum FoodItem {
    ...
    TIMOTHY_BALE_SLAB(Ingredient.of(SWEMBlocks.TIMOTHY_BALE_SLAB.get()), 1, 28, 4, 6, "", FoodItem::doNothing),
    ...
    QUALITY_BALE_SLAB(Ingredient.of(SWEMBlocks.QUALITY_BALE_SLAB.get()), 1, 112, 2, 3, "", FoodItem::doNothing),
