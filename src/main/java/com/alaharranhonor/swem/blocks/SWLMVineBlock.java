...
public class SWLMVineBlock extends Block implements net.minecraftforge.common.IForgeShearable {
...
public SWLMVineBlock(AbstractBlock.Properties properties) {
        super(properties);
        ...
        this.field_242684_o = ImmutableMap.copyOf(this.stateContainer.getValidStates().stream().collect(Collectors.toMap(Function.identity(), SWLMVineBlock::func_242685_h)));
        }
