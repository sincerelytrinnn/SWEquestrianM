...
public class HorseDoorBlock extends Block {
    ...
    public HorseDoorBlock(AbstractBlock.Properties builder, DyeColor colour) {
        super(builder);
        this.registerDefaultState(this.stateDefinition.any().setValue(FACING, Direction.NORTH).setValue(OPEN, Boolean.FALSE).setValue(HINGE, DoorHingeSide.LEFT).setValue(HALF, DoubleBlockHalf.LOWER));
        this.colour = colour;
    }
    ...
    public boolean canDropFromExplosion(BlockState state, IBlockReader world, BlockPos pos, Explosion explosion) {
        return state.getValue(HALF) == DoubleBlockHalf.LOWER && state.getValue(SIDE) == SWEMBlockStateProperties.DoubleBlockSide.LEFT;
    }
