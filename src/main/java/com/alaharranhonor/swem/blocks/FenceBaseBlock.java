...
public class FenceBaseBlock extends FourWayBlock {
    ...
    public FenceBaseBlock(Properties properties) {
        ...
        this.registerDefaultState(
                this.stateDefinition
                        ...
                        .setValue(HALF_FENCE, Boolean.valueOf(false)));
    ...
    public VoxelShape getRayTraceShape(
            BlockState state, IBlockReader reader, BlockPos pos, ISelectionContext context) {
    ...
    public BlockState updateShape(
        ...
        BlockState updated =
                facing.getAxis().getPlane() == Direction.Plane.HORIZONTAL
                        ? stateIn.setValue(
