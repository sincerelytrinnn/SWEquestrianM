...
public class BleacherWireframeBase extends SlabBlock {
    ...
    private final VoxelShape BOTTOM_SHAPE_WIREFRAME_BLEACHER =
            Stream.of(
    ...
    private final VoxelShape TOP_SHAPE_WIREFRAME_BLEACHER =
            Stream.of(
    ...
    private final VoxelShape FULL_BLOCK_WIREFRAME_BLEACHER =
            Stream.of(
                            Block.box(14, 8, 14, 16, 16, 16),
                            Block.box(0, 8, 14, 2, 16, 16),
                            Block.box(14, 8, 0, 16, 16, 2),
