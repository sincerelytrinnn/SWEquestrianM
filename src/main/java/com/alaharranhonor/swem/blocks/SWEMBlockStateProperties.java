...
public class SWEMBlockStateProperties {
    ...
    public static final EnumProperty<TackBoxType> TACK_BOX_TYPE =
            EnumProperty.create("type", TackBoxType.class);
    public static final EnumProperty<DoubleBlockSide> D_SIDE =
            EnumProperty.create("side", DoubleBlockSide.class);
    public static final EnumProperty<TripleBlockSide> T_SIDE =
            EnumProperty.create("side", TripleBlockSide.class);
    ...
    public enum TwoWay implements IStringSerializable {
        ...
        public String getSerializedName() {
            return this == SINGLE
                    ? "single"
                    : this == LEFT ? "left" : this == MIDDLE ? "middle" : "right";
        }
