...
public class BreastCollarLayer extends LayerRenderer<SWEMHorseEntity, SWEMHorseModel> {

	public BreastCollarLayer(IEntityRenderer<SWEMHorseEntity, SWEMHorseModel> entityRendererIn) {
