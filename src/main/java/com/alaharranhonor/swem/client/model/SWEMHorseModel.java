...
public class SWEMHorseModel extends AnimatedGeoModel<SWEMHorseEntity> {
    ...
    public static final Map<SWEMCoatColor, ResourceLocation> VARIANTS = Util.make(Maps.newEnumMap(SWEMCoatColor.class), (iter) -> {
        ...
        iter.put(SWEMCoatColor.JOEY_THIS_ESME, new ResourceLocation(SWEM.MOD_ID, "textures/entity/horse/coats/joey_this_esme.png"));
        ...
        iter.put(SWEMCoatColor.FARCAH_ZORSE_TAN_HAUKET, new ResourceLocation(SWEM.MOD_ID, "textures/entity/horse/coats/farcah_zorse_tan_hauket.png"));
        iter.put(SWEMCoatColor.SARINE_ZORSE_PAINT_HAUKET, new ResourceLocation(SWEM.MOD_ID, "textures/entity/horse/coats/sarine_zorse_paint_hauket.png"));
        iter.put(SWEMCoatColor.CALIHOPE_ZORSE_DARK_HAUKET, new ResourceLocation(SWEM.MOD_ID, "textures/entity/horse/coats/calihope_zorse_dark_hauket.png"));
        iter.put(SWEMCoatColor.COURIER_CALICO_HAUKET, new ResourceLocation(SWEM.MOD_ID, "textures/entity/horse/coats/courier_calico_hauket.png"));
        iter.put(SWEMCoatColor.GUARDIAN_BAY_GRAY_HAUKET, new ResourceLocation(SWEM.MOD_ID, "textures/entity/horse/coats/guardian_bay_gray_hauket.png"));
        iter.put(SWEMCoatColor.ROYAL_BRINDLE_HAUKET, new ResourceLocation(SWEM.MOD_ID, "textures/entity/horse/coats/royal_brindle_hauket.png"));
        iter.put(SWEMCoatColor.RIPTIDE_PEACOCK_HAUKET, new ResourceLocation(SWEM.MOD_ID, "textures/entity/horse/coats/riptide_peacock_hauket.png"));
        iter.put(SWEMCoatColor.ARIELS_MALLI, new ResourceLocation(SWEM.MOD_ID, "textures/entity/horse/coats/ariels_malli.png"));
        ...
        iter.put(SWEMCoatColor.POLARIS_MALLI, new ResourceLocation(SWEM.MOD_ID, "textures/entity/horse/coats/polaris_malli.png"));
        iter.put(SWEMCoatColor.DUSTAR_MALLI, new ResourceLocation(SWEM.MOD_ID, "textures/entity/horse/coats/dustar_malli.png"));
        iter.put(SWEMCoatColor.CALIHAN_MALLI, new ResourceLocation(SWEM.MOD_ID, "textures/entity/horse/coats/calihan_malli.png"));
        iter.put(SWEMCoatColor.VULCAN_ARISHANT, new ResourceLocation(SWEM.MOD_ID, "textures/entity/horse/coats/vulcan_arishant.png"));
        ...
        iter.put(SWEMCoatColor.MASQUERADE_ARISHANT, new ResourceLocation(SWEM.MOD_ID, "textures/entity/horse/coats/masquerade_arishant.png"));
        iter.put(SWEMCoatColor.MIKA_STARDUST, new ResourceLocation(SWEM.MOD_ID, "textures/entity/horse/coats/mika_stardust.png"));
        iter.put(SWEMCoatColor.PANAMA_MALLI, new ResourceLocation(SWEM.MOD_ID, "textures/entity/horse/coats/panama_malli.png"));
        iter.put(SWEMCoatColor.ASTERIA_ARISHANT, new ResourceLocation(SWEM.MOD_ID, "textures/entity/horse/coats/asteria_arishant.png"));
