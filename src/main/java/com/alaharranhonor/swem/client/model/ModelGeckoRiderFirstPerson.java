...
public class ModelGeckoRiderFirstPerson extends CustomAnimatedGeoModel<GeckoRider> {
	...
	public boolean resourceForModelId(AbstractClientPlayerEntity player) {
		this.animationFileLocation = new ResourceLocation(SWEM.MOD_ID, "animations/animated_player_first_person.animation.json");
		this.modelLocation = new ResourceLocation(SWEM.MOD_ID, "geo/animated_player_first_person.geo.json");
