 ...
 */
public abstract class CustomAnimatedGeoModel<T extends IAnimatable & IAnimationTickable>
    ...
    public void setLivingAnimations(
            T entity, Integer uniqueID, @Nullable AnimationEvent customPredicate) {
            ...
            manager.startTick =
                    (double)
                            (entity.tickTimer()
                                    ...
                                    .getFrameTime()); // Set start ticks when animation starts playing
        }
