...
public class RiderFirstPersonRenderer extends FirstPersonRenderer implements IGeoRenderer<GeckoRider> {
	public static GeckoRider.GeckoRiderFirstPerson GECKO_PLAYER_FIRST_PERSON;

	private static HashMap<Class<? extends GeckoRider>, RiderFirstPersonRenderer> modelsToLoad = new HashMap<>();
	...
	public void renderItemInFirstPerson(AbstractClientPlayerEntity player, float pitch, float partialTicks, Hand handIn, float swingProgress, ItemStack stack, float equippedProgress, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, GeckoRider geckoPlayer) {
