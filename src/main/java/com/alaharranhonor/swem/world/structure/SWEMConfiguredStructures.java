...
public class SWEMConfiguredStructures {
	 ...
	 */
	public static StructureFeature<?, ?> CONFIGURED_BARN = SWEMStructure.BARN.get().configured(IFeatureConfig.NONE);
	...
	public static void registerConfiguredStructures() {
		...
		Registry.register(registry, new ResourceLocation(SWEM.MOD_ID, "configured_barn"), CONFIGURED_BARN);
